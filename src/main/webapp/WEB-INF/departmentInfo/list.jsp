	...
	<div style="widht: 100%;">
		...
		<div
			...
			<a style="text-decoration: none;"
				...
				<div
					style="float: left; width: 46%; margin: 1% 1%; border: 1px solid gray; text-align: center; color: white; background-color: gray;">
					部門管理</div>
			</a> <a style="text-decoration: none;"
				href="<s:url action="postManage.action"/>">
				<div
					style="float: left; margin: 1% 1%; width: 46%; border: 1px solid gray; text-align: center; color: gray; background-color: #f1f1f1;">
					役職管理</div>
			</a>
			...
			<table style="margin: 2% auto; width: 95%;">
				...
				<c:forEach var="e" varStatus="s" items="${departmentList}">
					<tr>
						...
						<td>${e.dep_number}</td>
						<td><a
							href="<s:url action="departmentEdit.action">
						<s:param name="id">${e.dep_id}</s:param>
						</s:url>">編集</a></td>
						<td><a
							href="<s:url action="departmentDelete.action">
						<s:param name="id">${e.dep_id}</s:param>
						</s:url>">削除</a></td>
					</tr>
				</c:forEach>
